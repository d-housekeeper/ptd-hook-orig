...
static AndroidJavaObjectPtr getCurrentActivity(const AndroidJavaObjectPtr &unityPlayerClass) {
...
static AndroidJavaObjectPtr getApplicationContext(const AndroidJavaObjectPtr &activity) {
...
static AndroidJavaObjectPtr getExternalFilesDirFromContext(const AndroidJavaObjectPtr &context) {
