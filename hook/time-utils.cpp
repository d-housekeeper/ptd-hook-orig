...
bool timeZoneOffsetInMillisCached = false;
int timeZoneOffsetInMillis = 0;

AndroidJavaObjectPtr getDefaultTimeZone(const AndroidJavaObjectPtr &timeZoneClass) {
...
int getTimeZoneOffset(const AndroidJavaObjectPtr &timeZone, int64_t currentTime) {
